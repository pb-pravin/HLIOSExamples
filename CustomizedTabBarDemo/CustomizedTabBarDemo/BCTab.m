...
- (id)initWithIconImageName:(NSString *)imageName {
	if (self = [super init]) {
		...
		self.background = [[UIImage imageNamed:@"TabBackground.png"] stretchableImageWithLeftCapWidth:1 topCapHeight:0];
		self.rightBorder = nil;//[UIImage imageNamed:@"BCTabBarController.bundle/tab-right-border.png"];
